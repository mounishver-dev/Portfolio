...
function App() {
  ...
  useEffect(() => {
    // Only enable cursor glow on devices that support hover (i.e. not touch-only)
  ...
  return (
    <>
      ...
      <div className="hero-section">
        <img src={bg} className="background" alt="" aria-hidden="true" />
        ...
        >
          <div className="flip-card-inner">
            ...
            <div className="flip-card-back">
              ...
              <h3>(Full stack developer &amp; Graphical Designer)</h3>
              <h2>Code meets Creativity.</h2>
              <h2>I build experiences that connect.</h2>
            </div>
          </div>
        </div>

        {/* Tap hint shown only on touch devices */}
